 ...
 <div class="contents">
   ...
   <div class="main-2">
    ...
    <div class="box-1 ui-bg-1">
      ...
      <div class="ui-bg-2">
        <ul class="ui-list-1">
          <li><a href="tramites-navegacion-n2.php">Ambiente</a></li>
          <li><a href="tramites-navegacion-n2.php">Ciencia, tecnolog&iacute;a e innovaci&oacute;n</a></li>
          <li><a href="tramites-navegacion-n2.php">Cultura</a></li>
          <li><a href="tramites-navegacion-n2.php">Desarrollo social</a></li>
          <li><a href="tramites-navegacion-n2.php">Econom&iacute;a y finanzas</a></li>
        
          <li><a href="tramites-navegacion-n2.php">Educaci&oacute;n</a></li>
          <li><a href="tramites-navegacion-n2.php">Ejes de gestión</a></li>
          <li><a href="tramites-navegacion-n2.php">H&aacute;bitat y vivienda</a></li>
          <li><a href="tramites-navegacion-n2.php">Impuestos</a></li>
        </ul>
      </div>
      ...
      <div class="box-7">
        <ul class="ui-list-4">
          ...
          <li><a href="#"><i class="icon-tramites"></i>Municipios y Comunas-Patente Única sobre Vehículos: Parámetros de Emisión</a></li>
          <li><a href="#"><i class="icon-tramites"></i>Impuesto Inmobiliario/Patente Única sobre Vehículos: Solicitud de Emisión de Boletas</a></li>
          <li><a href="#"><i class="icon-tramites"></i>Promoción Industrial: Solicitud de exención de impuestos provinciales para empresas</a></li>
          <li><a href="#"><i class="icon-tramites"></i>Beneficios para el Biocombustible - Exención de tributos </a></li>
          <li><a href="#"><i class="icon-tramites"></i>Patente Única sobre Vehículos: Transferencias</a></li>
          <li><a href="#"><i class="icon-tramites"></i>Patente Única sobre Vehículos: Exenciones</a></li>
          <li><a href="#"><i class="icon-tramites"></i>Patente Única sobre Vehículos: Modificaciones</a></li>
          <li><a href="#"><i class="icon-tramites"></i>Patente Única sobre Vehículos: Solicitud de Imputación de un pago</a></li>
          <li><a href="#"><i class="icon-tramites"></i>Vehículos: Revisión Técnica Vehicular Obligatoria</a></li>
        </ul>   
      </div> 
   </div>
