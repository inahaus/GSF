...
<html lang="en">
  <head>
    ...
    <title>Tramites - Busqueda avanzada</title>
 ...
 <div class="contents">
   ...
   <div class="main-2">
    ...
    <div class="box-1 ui-bg-1">
      <h3 class="ui-h2-1">B&uacute;squeda de tr&aacute;mites</h3>
      <p>Resultados de búsqueda para <strong>patente</strong></p>
    </div>
      <div class="box-7">
        <ul class="ui-list-4">
        ...
        <p class="ver-mas">
          <a href="#" id="ver-mas" class="caret-title">
            Cargar m&aacute;s resultados           
