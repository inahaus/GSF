...
<div class="container hidden-desktop">
  ...
  <div class="box-6 ui-bg-9">
    <div class="container">
      <h2 class="ui-h2-3"><a href="#">Licitaciones</a></h2>
    </div>
  </div>
  ...
  <div class="container" role="main">
    ...
    <div class="contents"> 
      ...
      <h3 class="ui-h3-1"><i class="icon-flechad"></i> Licitaciones y concursos </h3>
      ...
      <div class="tabs-compras">
        ...
        <div class="ui-bg-2">
          <div class="tabs">
            <ul class="tabs-nav">
              <li class="active"><a href="#" data-target="tab-1">Apertura</a></li>
              <li><a href="#" data-target="tab-2">Licitadas</a></li>       
            </ul>
            <div class="tab-contents">
              <div class="tab-content tab-1 active">
                <table>
                  ...
                  <tr>
                    <td>28/07/2014 09:00</td>
                    <td>Licitación Pública N°14/2014 - Ejecución de la Obra "Ruta Provincial</br> N°21, tramo Villa Gobernador Gálvez - Acceso a Puerto Alvear. Ampliación de calzadas"</td>
                    <td>$100.495.027,52</td>
